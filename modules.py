...
class incondition__(nn.Module):
    def __init__(self,in_channels = 4,out_channels=32,emb_dim=256):
...
class UNet(nn.Module):
    def __init__(self, c_in=3, c_out=3, time_dim=256, device="cuda"):
        ...
        self.incontidion = nn.Sequential(DoubleConv(c_in,32),DoubleConv(64,64))

        self.down1 = Down(64, 128)
        self.att_1 = SelfAttention(128,128)
        self.down2 = Down(128, 256)
        self.att_2 = SelfAttention(256, 64)
        self.down3 = Down(256, 256)
        self.att_3 = SelfAttention(256, 32)
        ...
        self.up1 = Up(512, 128)
        self.att_4 = SelfAttention(128, 64)
        self.up2 = Up(256, 64)
        self.att_5 = SelfAttention(64, 128)
        self.up3 = Up(128, 64)
...
class UNet_conditional(nn.Module):
    def __init__(self, c_in=4, c_out=4, time_dim=256,  device="cuda"):
        ...
        self.incondition = incondition__(in_channels=4,out_channels=32)

        self.down2 = Down(64, 128)# 128  256

        self.down3 = Down(128, 256)# 256  256

        self.down4 = Down(256, 512)  # 256  256

        self.down5 = Down(512, 512)  # 256  256
...
# x = torch.randn(4, 4, 256, 256).to("cuda:0")
# t = x.new_tensor([500] * x.shape[0]).long().to("cuda:0")
# net = UNet_conditional(c_in=4,c_out=4).to("cuda:0")
# net(x,t,x)
